...
if(int(cm)<40) or(int(cppm)<40) or (int(pym)<40):
	...
	if(totmarks in range(250,301)):
		...
		grade="THIRD"
#Save Student Marks Report in Log File
logging.basicConfig(filename="student.data",level=logging.INFO)
logging.info("*"*50)
logging.info("\t\tSTUDENT MARKS REPORT")
logging.info("*"*50)
logging.info("\tStudent Number:{}".format(sno))
logging.info("\tStudent Name:{}".format(sname))
logging.info("\tStudent Marks in C:{}".format(cm))
logging.info("\tStudent Marks in C++:{}".format(cppm))
logging.info("\tStudent Marks in Python:{}".format(pym))
logging.info("\tStudent Total Marks :{}".format(totmarks))
logging.info("\tStudent Percentage of Marks :{}".format(percent))
logging.info("\tStudent Grade : {}".format(grade))
logging.info("*"*50)
print("Student Marks Report Saved in File")
